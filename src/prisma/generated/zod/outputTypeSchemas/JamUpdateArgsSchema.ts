...
export const JamUpdateArgsSchema: z.ZodType<Prisma.JamUpdateArgs> = z.object({
  select: JamSelectSchema.optional(),
  include: JamIncludeSchema.optional(),
  data: z.union([ JamUpdateInputSchema,JamUncheckedUpdateInputSchema ]),
  where: JamWhereUniqueInputSchema,
}).strict()

export default JamUpdateArgsSchema;
