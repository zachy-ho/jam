...
export const JamOrganiserUpsertArgsSchema: z.ZodType<Prisma.JamOrganiserUpsertArgs> = z.object({
  ...
  create: z.union([ JamOrganiserCreateInputSchema,JamOrganiserUncheckedCreateInputSchema ]),
  update: z.union([ JamOrganiserUpdateInputSchema,JamOrganiserUncheckedUpdateInputSchema ]),
}).strict()

export default JamOrganiserUpsertArgsSchema;
