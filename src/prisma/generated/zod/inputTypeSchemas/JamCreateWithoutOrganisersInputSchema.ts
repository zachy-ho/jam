...
export const JamCreateWithoutOrganisersInputSchema: z.ZodType<Prisma.JamCreateWithoutOrganisersInput> = z.object({
  id: z.string(),
  name: z.string(),
...
export default JamCreateWithoutOrganisersInputSchema;
